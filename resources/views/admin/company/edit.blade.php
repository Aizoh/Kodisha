                    ...
                    <form action="{{route('company.update', $company->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="company_name" class="form-control" id="form_control_1" value="{{$company->company_name}}">
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="company_phone" class="form-control" id="form_control_1" value="{{$company->company_phone}}">
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="physical_address" class="form-control" id="form_control_1" value="{{$company->physical_address}}">
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input name="company_email" type="email" class="form-control" id="form_control_1" value="{{$company->company_email}}">
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="zip_code" class="form-control" id="form_control_1" value="{{$company->zip_code}}">
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="slang" class="form-control" id="form_control_1" value="{{$company->slang}}">
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
