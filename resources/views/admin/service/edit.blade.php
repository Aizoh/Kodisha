            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <a href="{{ Route('service.index') }}" class="btn btn sbold red btn-sm active">back</a>
                    ...
                    <div class="form-body row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="name" class="form-control" id="form_control_1" value="{{$service->name}}">
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <textarea type="text" name="description" class="form-control" id="form_control_1" rows="3">{{$service->description}}</textarea>
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
                            <br>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-10">
                                    <textarea name="full_description" class="form-control" id="form_control_1" rows="5">
