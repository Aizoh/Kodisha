            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject font-green bold uppercase"> Edit A team member</span>
                    </div>
                    ...
                    <div class="form-body row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="names" class="form-control" id="form_control_1" value="{{$team->names}}">
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="phone" class="form-control" id="form_control_1" value="{{$team->phone}}">
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input type="email" name="email" class="form-control" id="form_control_1" value="{{$team->email}}">
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input type="text" name="department" class="form-control" id="form_control_1" value="{{$team->department}}">
                                    <div class="form-control-focus"> </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group form-md-line-input">
                                ...
                                <label class="col-md-4  control-label">Designation</label>
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="designation" class="form-control" id="form_control_1" value="{{$team->designation}}">
                                        <div class="form-control-focus"> </div>
                                    </div>
