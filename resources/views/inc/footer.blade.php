<footer>
   ...
   <div class="row">
     <div class="col-sm-10 col-md-10 mx-auto mt-5">
      <div class="footer">
        <p class="footer-text">Realestate Group is committed to ensuring digital accessibility for individuals with
        ...
        <p class="footer-text mt-4">
          Copyright © 2020 Nepestate, LLC. All rights reserved. Equal Housing Opportunity. Have a Question? Visit our
